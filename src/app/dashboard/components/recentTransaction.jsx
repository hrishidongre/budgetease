...
export default function RecentTransaction({ transactions, title = "Recent Transactions", subtitle = "Your latest spending activity" }) {
  return (
    <div className="bg-white rounded-xl p-4 shadow-md w-full max-w-sm">
      ...
      <div className="flex flex-col gap-3">
        {transactions.slice(0, 3).map((tx, idx) => (
          <div key={idx} className="flex items-center justify-between bg-[#f9fbfe] p-3 rounded-md">
