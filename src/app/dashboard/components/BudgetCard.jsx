...
import AddExpenseDialog from './addExpenseDlalog';
...
//       <div className="relative bg-white rounded-lg p-6 shadow-md group transition-all duration-300 h-full hover:shadow-xl hover:scale-[1.01]">
//         {/* Header */}
...
//           {/* Trigger button for Add Expense dialog */}
//           <AddExpenseDialog
//             trigger={
//               <button
//                 className="opacity-0 group-hover:opacity-100 transition-opacity duration-200 text-blue-500 rounded-full w-8 h-8 flex items-center justify-center text-2xl"
//                 title="Add Expense"
//               >
//                 +
//               </button>
